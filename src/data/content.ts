// Fonte única da copy da LP Ultraformer (`/`) — mantém o texto original da Dra. Karol
// separado da apresentação, para facilitar revisões de conteúdo sem tocar em JSX.
// A LP de glúteos (`/gluteos/`) vive em `content.gluteos.ts`, com o mesmo contrato (`types.ts`).

import type { SiteContent } from './types';
import logo from '../assets/logo.png';
import heroPhoto from '../assets/hero.png';
import recepcaoPhoto from '../assets/recepcao1.png';
import ultraformerPhoto from '../assets/ultraformer.jpg';
import atendimentoPhoto from '../assets/atendimento.jpg';
import clinicaPhoto from '../assets/clinica.jpg';
import resultadoPhoto from '../assets/resultado.jpg';
import papadaPhoto from '../assets/papada.jpg';
import contornoPhoto from '../assets/contorno.jpg';
import rugasPhoto from '../assets/rugas.jpg';
import corpoPhoto from '../assets/corpo.jpg';
...
export const content: SiteContent = {
  ...
  hero: {
    ...
    photo: heroPhoto,
    photoPlaceholder: 'Dra. Karol',
  },

  trustBar: ['Equipamento certificado', 'Avaliação individualizada', 'Atendimento no Centro de Curitiba'],
  ...
  procedure: {
    photoStyle: 'cutout',
    photo: ultraformerPhoto,
    photoAlt: 'Aparelho Ultraformer III',
    statement: 'Sem cortes e agulha. Procedimento não invasivo.',
  },
    ...
    categories: [
      {
        ...
        photoPlaceholder: 'Antes e depois — papada e linha do maxilar',
        photo: contornoPhoto,
      },
      {
        title: 'Contorno facial',
        text: 'Valorização das linhas do rosto com naturalidade.',
        photoPlaceholder: 'Antes e depois — contorno facial com Ultraformer',
        photo: papadaPhoto,
      },
      {
        title: 'Rugas',
        text: 'Suavização progressiva dos sinais de envelhecimento.',
        photoPlaceholder: 'Antes e depois — suavização de rugas',
        photo: rugasPhoto,
      },
      {
        title: 'Corpo',
        text: 'Abdômen, braços e coxas — firmeza onde a pele perdeu sustentação.',
        photoPlaceholder: 'Antes e depois — abdômen com Ultraformer',
        photo: corpoPhoto,
        photoFit: 'contain',
      },
    ],
  ...
  security: {
    ...
    photo: clinicaPhoto,
    photoPlaceholder: 'Sala de espera da clínica',
    ctaCell: {
  ...
  results: {
    ...
    author: 'Vitoria M.',
    ctaLabel: 'Quero avaliar meu caso',
    photo: resultadoPhoto,
    photoPlaceholder: 'Antes e depois — contorno do maxilar, paciente da Dra. Karol',
  },
